...
author: Cubit Development Team
output:
  rmarkdown::html_vignette:
    toc: yes
vignette: '%\VignetteIndexEntry{Getting Started with Cubit} %\VignetteEngine{knitr::rmarkdown}
...
<img src="b3/CubitInput_upload.gif" alt="" width="100%" />
...
<img src="b3/CubitCube_configuration.gif" alt="" width="100%" />
...
<img src="b3/CubitCube_merging.gif" alt="" width="100%" />
...
You also need to define a file name for the output merged cube, which, again, which will be created with this name in the same directory as the input file and you don't need to download.
